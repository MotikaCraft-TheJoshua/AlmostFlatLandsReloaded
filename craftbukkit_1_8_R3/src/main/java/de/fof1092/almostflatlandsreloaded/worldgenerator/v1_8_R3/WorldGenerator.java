...
public class WorldGenerator extends ChunkGenerator {
    ...
    public ChunkData generateChunkData(World world, Random random, int chunkX, int chunkZ, BiomeGrid biomeGrid) {
        ...
        Bukkit.getLogger().info("[AlmostFlatLandsReloaded] Generating chunk: " + chunkX + ", " + chunkZ);
        ...
        for (int x = 0; x < 16; x++) {
            for (int z = 0; z < 16; z++) {
                ...
                Bukkit.getLogger().info("[AlmostFlatLandsReloaded] WorldGenerator: x=" + x + ", z=" + z + ", height=" + (int) normalHeight);
